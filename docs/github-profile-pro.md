...
## 2) Repositorios pineados (orden recomendado)
1. `FitMenu` (IA + producto + UX + backend).
2. Proyecto full-stack empresarial (Java/Spring o Nest).
...
Incluye:
- propuesta profesional en 4-5 lineas,
- stack tecnico principal,
- 3 proyectos estrella con enlaces y 1 frase de impacto cada uno,
...
- Pull Requests en proyectos open source (aunque sean 2-3 bien hechos).

## 6) Checklist rapido (15 min)
- Actualizar bio.
- Reordenar pins.
